...
INPUT_DIR = SCRIPT_DIR / "ratio_jk_manual_real2pt_opp"
OUTPUT_DIR = SCRIPT_DIR / "bare_matrix_element_jk_opp_400cfgs"
...
def process_parameter_point(operator, q_tuple, pf_tuple, flow):
    ...
    with h5py.File(out_path, "w") as f:
        ...
        f.attrs["input_ratio_dir"] = str(INPUT_DIR)
...
def main():
    ...
    with ProcessPoolExecutor(max_workers=N_WORKERS) as executor:
        futures = [executor.submit(process_parameter_point, *task) for task in tasks]
