...
INPUT_DIR = SCRIPT_DIR / "bare_matrix_element_linear_combination"
OUTPUT_DIR = SCRIPT_DIR / "forward_itd_ratios"
...
for flow in FLOW_LIST:
    ...
    with h5py.File(output_path, "w") as f:
        ...
        f.attrs["source"] = "bare_matrix_element_linear_combination"
