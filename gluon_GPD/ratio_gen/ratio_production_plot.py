...
def process_one(task):
    ...
    for op_name, op_idx in operator_plot_list:
        ...
        ratio_out = (
            f"./ratio_jk_manual/{op_name}_ratio_jk_{q_label}_{pf_label}_"
        ...
        for itsep, tsep in enumerate(tsep_list):
            ...
            jk_2pt_f_T = jk_ls_pt2_f[:, tsep]
            jk_2pt_i_T = jk_ls_pt2_i[:, tsep]
            jk_2pt_f_tau = jk_ls_pt2_f[:, tau]
            jk_2pt_i_tau = jk_ls_pt2_i[:, tau]
            jk_2pt_f_Tmtau = jk_ls_pt2_f[:, t_minus_tau]
            jk_2pt_i_Tmtau = jk_ls_pt2_i[:, t_minus_tau]
            jk_2ptFF = op_then_jk_3pt[:, itsep, :tsep + 1]
            jk_FF = op_then_jk_FF[:, :tsep + 1]

            jk_numerator = jk_2ptFF - jk_2pt_f_T[:, None] * jk_FF
            ...
            jk_ratio_complex = jk_raw_ratio * factor * symmetric_phase
