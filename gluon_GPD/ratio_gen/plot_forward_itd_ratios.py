...
INPUT_DIR = SCRIPT_DIR / "forward_itd_ratios"
PLOT_DIR = SCRIPT_DIR / "forward_itd_ratio_plots"
...
for flow in FLOW_LIST:
    ...
    for ratio_name in ["single", "double"]:
        for part in ["real", "imag"]:
            ...
            ax.set_title(
                f"{COMBO_NAME}; {title}; q={Q_TUPLE}; flow={flow}; zref={W_REF}"
            )
            ...
            plot_name = (
                f"{COMBO_NAME}_{ratio_name}_{part}_"
